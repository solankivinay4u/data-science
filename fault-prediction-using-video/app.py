...
def load_lrcn_model():
    ...
    model = load_model('/app/data-science/fault-prediction-using-video/model/LRCN_model___Date_Time_2022_09_14__17_23_36___Loss_0.8800032734870911___Accuracy_0.6571428775787354.h5')
    return model
